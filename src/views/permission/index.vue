    ...
    <div class="page-container">
        ...
        <div>
            <el-button type="primary" :loading="listLoading" :disabled="listLoading" @click="listFilter"
                       v-permission="['PERMISSION_LIST']">搜索
            </el-button>
            <el-button type="success" @click="handleCreate" v-permission="['PERMISSION_CREATE']">新建</el-button>
        </div>
                ...
                >
                    <template slot-scope="scope">
                        ...
                        <el-button type="primary" size="mini" @click="handleEdit(scope.row)"
                                   v-permission="['PERMISSION_UPDATE']">编辑
                        </el-button>
                        <el-button type="danger" size="mini" @click="doDelete(scope.row)"
                                   v-permission="['PERMISSION_DELETE']">删除
                        </el-button>
    ...
    export default {
        ...
        methods: {
            getList() {
                ...
                http.get('/permissions', {params: this.listQuery}).then(data => {
                    this.list = data.list;
            ...
            doDelete(row) {
                this.$confirm('确定要执行此操作吗?', '提示', {
                    ...
                    this.loading = true;
                    http.delete(`/permissions/${row.id}`).then(() => {
